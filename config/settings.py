...
ALLOWED_HOSTS = ["127.0.0.1", "adilmohak1.pythonanywhere.com", "lmsqduc-ccf8672e05cb.herokuapp.com"]
...
EMAIL_HOST_USER = config("EMAIL_HOST_USER", default="quangducngo0811@gmail.com")
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD", default="quangduc08")
EMAIL_FROM_ADDRESS = config(
    "EMAIL_FROM_ADDRESS", default="SkyLearn <quangducngo0811@gmail.com>"
)
EMAIL_USE_SSL = False
